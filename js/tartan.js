...
var effects=1; // how many of the effect are on the page
var speed=50; // how fast is the animation (lower is faster)
//var speed=5000; // how fast is the animation (lower is faster)
var speed=5000000; // how fast is the animation (lower is faster)
//var colours=new Array("#9cf", "#c9f", "#fc9", "#f9c", "#cf9", "#9fc", "#6ff", "#f6f", "#ff6");
//var colours=new Array("#9cf", "#c9f", "#fc9", "#f9c", "#cf9", "#9fc", "#6ff", "#f6f", "#ff6");
//var colours=new Array("#425945");
var colours=new Array("#333");
//var colours=new Array("#423900");
//var colours=new Array("#000", "#000");
...
function set_width() {
  ...
  /*
  console.log("docel width: " + sw_min);
  console.log("docel height: " + sh_min);
  */
  ...
  /*
  console.log("inn width: " + sw_min);
  console.log("inn height: " + sh_min);
  ...
  */
  ...
  /*
  console.log("bod width: " + sw_min);
  console.log("bod height: " + sh_min);
  */
  swide=sw_min;
  shigh=sh_min;
